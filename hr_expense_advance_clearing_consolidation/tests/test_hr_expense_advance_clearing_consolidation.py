...
class TestHrExpenseAdvanceClearingConsolidation(common.SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.advance1 = cls._create_expense_sheet(
            cls, "Advance1 1,000", cls.employee, cls.emp_advance, 1000.0, advance=True
        )
        cls.advance2 = cls._create_expense_sheet(
            cls, "Advance2 1,000", cls.employee, cls.emp_advance, 1000.0, advance=True
        )
        cls.advance3 = cls._create_expense_sheet(
            cls, "Advance3 1,000", cls.employee, cls.emp_advance, 1000.0, advance=True
        )

        ...
        extra.append(
            {
                ...
                "sign_symbol": SIGN_SYMBOLS[sign_i],
                "position": f"{deg}°{minute:02d}'",
                # Whole Sign houses are whole signs counted from the Ascendant,
                # so the Midheaven is not tied to the tenth: at higher
                # latitudes it lands in the ninth or the eleventh
                "house": get_house(mc_lon, houses),
            }
        )

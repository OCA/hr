...
class HrAccidentatwork(models.Model):
    ...
    number_of_employee_concerned_acknowledge_by_social_security = fields.Integer(
        string='Number of Employee concerned and acknowledge by the Social Security Authority', default=0)
    ...
    accident_during_commute = fields.Boolean(string='Accident during the commuting ?', default=False)
    ...
    work_stoppage_duration_working_days = fields.Integer(
        ...
        #compute='_compute_duration_work_days')

...
class HrExpenseSheet(models.Model):
    ...
    def action_sheet_move_create(self):
        ...
        move_lines = (
            ...
            .search([("ref", "in", self.mapped("name"))])
            .mapped("line_ids")
        )
        for line in expense_line_ids:
            ...
            c_move_lines = move_lines.filtered(
                ...
                and x.debit == line.invoice_id.residual
            ...
            c_move_lines |= line.invoice_id.move_id.line_ids.filtered(
                ...
                and float_compare(x.credit, residual, precision) == 0
            )
            if len(c_move_lines) != 2:
                raise UserError(
                    _(
                        "Cannot reconcile supplier invoice payable with "

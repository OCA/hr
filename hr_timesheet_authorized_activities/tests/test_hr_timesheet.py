...
class test_hr_timesheet(common.TransactionCase):
    ...
    def setUp(self):
        super(test_hr_timesheet, self).setUp()
    ...
    def tearDown(self):
        ...
        super(test_hr_timesheet, self).tearDown()
    ...
    def test_search_activities_from_user(self):
        ...
        # Job 1 and sick leaves are not in the account's authorized activities

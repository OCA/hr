...
`here <https://github.com/OCA/hr/issues/new?body=module:%20hr_employee_legacy_id%0Aversion:%208.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.

...
class TestHREmployeePPE(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.hr_employee_ppe_equipment_no_expirable = cls.hr_employee_ppe_equipment.create({
    ...
    def test_compute_status(self):
        ...
        self.hr_employee_ppe_expirable.end_date = (datetime.now() + timedelta(days=1)).strftime(
            "%Y-%m-%d"
        )
        self.hr_employee_ppe_expirable._compute_status()

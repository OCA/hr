...
class langreport(report_sxw.rml_parse):
    ...
    def _getLang(self, id):
        ...
        lid.append(pooler.get_pool(self.cr.dbname).get('emp.lang')
                   .search(self.cr, self.uid, [('ii_id', '=', id), ]))
...
report_sxw.report_sxw('report.langreport', 'hr.employee',
                      'addons/hr_skill/report/langreport.rml', parser=langreport,)

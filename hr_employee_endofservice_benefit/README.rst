...
This module calculates employee's end of service benefit a benefit paid to 
an employee at end of service. Calculation is based on the time spent by 
employee in company
...
Add benefit calculation rule to employee's contract category

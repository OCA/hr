...
class TestEmployeeID(common.TransactionCase):
    ...
    def test_random_id_generation(self):
        ...
        self.assertAlmostEqual(len(employee.employee_number), 5)
    ...
    def test_random_id_generation_changed_digits(self):
        ...
        self.assertAlmostEqual(len(employee.employee_number), 10)
    ...
    def test_sequences_id_generation(self):
        ...
        self.assertTrue(len(employee.employee_number))
    ...
    def test_no_sequences_id_generation(self):
        ...
        self.assertEqual(employee.employee_number, False)
    ...
    def test_custom_id(self):
        ...
        employee = self.employee_model.create(
            {"name": "Employee", "employee_number": "THERE_YOU_GO"}
        )
        self.assertEqual(employee.employee_number, "THERE_YOU_GO")
